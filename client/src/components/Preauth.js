            ...
            <div className="preauth" >
                <div class="shadow p-3 mb-0 bg-body rounded">
                    <div className="container">
                        <div className="container">
                            <div  style={{textAlign:"center"}} class="alert alert-primary" role="alert">
                               <strong>Preauthauthorization Request Form</strong>
                            </div>
                         </div>   
                            <form  method="POST" style={{marginLeft:"50px"}} >
                                <div className='preauth row'><br></br><br></br>
                                    <div className="col-lg-4" style={{marginLeft: "-30px"}}><br></br>
                                ...
                                <div   style={{marginLeft:"-50px"}} className="preauthtitle">
                            ...
                            <center>
                                <button type="button" value="submit" onClick={PostData} class="btn btn-primary" style={{borderRadius: "30px",fontSize: "20px",width: "150px" , marginLeft:"-570px"}}> <strong>Submit</strong></button>
                            </center>
                            </div>
                        </form>
